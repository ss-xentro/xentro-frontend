...
export const STAT_CARDS: StatCardConfig[] = [
	{ label: 'Sectors', icon: STAT_ICONS.sectors, bgColor: 'bg-blue-500/20', iconColor: 'text-blue-300' },
	{ label: 'Portfolio Companies', icon: STAT_ICONS.portfolio, bgColor: 'bg-purple-500/20', iconColor: 'text-purple-300' },
	{ label: 'Total Invested', icon: STAT_ICONS.invested, bgColor: 'bg-green-500/20', iconColor: 'text-green-300' },
	{ label: 'Notable Investments', icon: STAT_ICONS.notable, bgColor: 'bg-amber-500/20', iconColor: 'text-amber-300' },
];
