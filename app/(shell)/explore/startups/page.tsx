...
function StartupsContent() {
    ...
    const stageColor: Record<string, string> = {
        ideation: 'bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 border-purple-500/20',
        pre_seed_prototype: 'bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border-blue-500/20',
        seed_mvp: 'bg-teal-100 dark:bg-teal-500/20 text-teal-700 dark:text-teal-300 border-teal-500/20',
        early_traction: 'bg-cyan-100 dark:bg-cyan-500/20 text-cyan-700 dark:text-cyan-300 border-cyan-500/20',
        growth: 'bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-300 border-green-500/20',
        scaling: 'bg-yellow-100 dark:bg-yellow-500/20 text-yellow-700 dark:text-yellow-300 border-yellow-500/20',
    };
