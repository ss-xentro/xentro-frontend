...
export function VerifiedBadge({ verified, status }: { verified: boolean; status: string }) {
	if (verified) {
		return (
			<span className="inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full bg-(--success-light) text-(--success) border border-(--success)/25">
	...
	if (status === 'approved') {
		return (
			<span className="inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full bg-blue-500/15 text-blue-600 dark:text-blue-400 border border-blue-500/25">
				<svg className="w-3.5 h-3.5" viewBox="0 0 20 20" fill="currentColor">
...
export function InstitutionalBadge({ name }: { name: string }) {
	return (
		<span className="inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full bg-purple-500/15 text-purple-600 dark:text-purple-400 border border-purple-500/25">
