					...
					<div className="flex items-start gap-6 mb-6">
						...
						<div className="flex-1">
							...
							<div className="flex items-center gap-3 mt-3">
								...
								<span className={`px-2 py-1 rounded-full text-xs font-medium ${mentor.status === 'approved' || mentor.status === 'active' ? 'bg-blue-500/20 text-blue-200' : 'bg-(--accent-light) text-gray-100'}`}>
									{mentor.status}
								</span>
