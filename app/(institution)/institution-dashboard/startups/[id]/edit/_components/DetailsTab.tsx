	...
	return (
		<>
			<Card className="p-6 space-y-6">
				...
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Tagline</label>
				...
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">One-Line Pitch</label>
					...
					<p className="text-xs text-(--secondary) mt-1">{formData.oneLiner.length} / 280</p>
				</div>

				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Pitch (160 chars)</label>
					...
					<p className="text-xs text-(--secondary) mt-1">{formData.pitch.length} / 160</p>
				</div>

				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Description</label>
				...
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Industry</label>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div>
						<label className="block text-xs font-medium text-(--secondary-light) mb-2">Logo URL</label>
						<input type="text" value={formData.logo} onChange={(e) => onFieldChange('logo', e.target.value)} className={INPUT_CLASS} placeholder="https://..." />
					</div>
					<div>
						<label className="block text-xs font-medium text-(--secondary-light) mb-2">Cover Image URL</label>
			...
			<Card className="p-6 space-y-6">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div>
						<label className="block text-xs font-medium text-(--secondary-light) mb-2">Stage</label>
						<Select value={formData.stage} onChange={(val) => onFieldChange('stage', val)} options={STAGE_OPTIONS} />
					</div>
					<div>
						<label className="block text-xs font-medium text-(--secondary-light) mb-2">Status</label>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div>
						<label className="block text-xs font-medium text-(--secondary-light) mb-2">Founded Date</label>
				...
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Primary Contact Email</label>
