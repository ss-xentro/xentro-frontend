...
export function LinksTab({ formData, onFieldChange }: LinksTabProps) {
	return (
		<Card className="p-6 space-y-6">
			<h3 className="text-lg font-semibold text-(--primary)">Links & Social</h3>

			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Website</label>
				...
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">LinkedIn</label>
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Twitter</label>
				...
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Instagram</label>
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Pitch Deck URL</label>
				...
				<div>
					<label className="block text-xs font-medium text-(--secondary-light) mb-2">Demo Video URL</label>
