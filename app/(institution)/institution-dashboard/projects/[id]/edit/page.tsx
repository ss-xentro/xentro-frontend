...
export default function EditProjectPage() {
	...
	return (
		<DashboardSidebar>
			<div className="max-w-2xl mx-auto px-6 py-12">
				<div className="mb-12">
					<h1 className="text-2xl font-semibold text-white mb-2">Edit Project</h1>
					...
					<form onSubmit={handleSubmit} className="space-y-12">
						<div className="space-y-6">
							<div>
								...
								<input type="text" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="w-full px-4 py-3 text-sm bg-white/5 border border-white/20 text-white rounded-lg focus:border-white/40 focus:outline-none transition-colors" placeholder="e.g., AI Research Hub" required />
							</div>
							<div>
						...
						<div className="space-y-3">
							...
							<textarea value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} rows={5} className="w-full px-4 py-4 text-sm bg-white/5 border border-white/20 rounded-lg focus:border-white/40 focus:bg-white/10 focus:outline-none transition-all resize-none" placeholder="Describe the project" />
						</div>
