		...
		<DashboardSidebar>
			<div className="p-8 space-y-6 animate-fadeIn">
				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
					<StatCard icon="rocket" bg="bg-purple-500/20" label="Active Programs" value={stats.programsCount} />
					<StatCard icon="users" bg="bg-blue-500/20" label="Team Members" value={stats.teamCount} />
					<StatCard icon="briefcase" bg="bg-amber-500/20" label="Portfolio Startups" value={stats.startupsCount} />
					<StatCard icon="bar-chart" bg="bg-green-500/20" label="Profile Views" value={stats.profileViews} />
				</div>
				...
				<Card className="p-6">
					...
					<div className="flex gap-3 mt-6 pt-6 border-t border-(--border)">
						...
						{(institution?.slug || institutionPublicId) && (
							<>
								<Link href={`/institutions/${institution?.slug || institutionPublicId}`}>
									<Button>
