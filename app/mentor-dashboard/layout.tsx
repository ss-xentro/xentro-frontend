...
export default function MentorDashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        {
            name: 'Requests', href: '/mentor-dashboard/requests', icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Calendar', href: '/mentor-dashboard/calendar', icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
        ...
        {
            name: 'Endorsements', href: '/mentor-dashboard/endorsements', icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Settings', href: '/mentor-dashboard/settings', icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
