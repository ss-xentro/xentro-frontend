    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            <div>
                ...
                <p className="text-(--secondary) mt-1">Here&apos;s what&apos;s happening with your institutions today.</p>
            </div>
                    ...
                    <div className="h-64 flex items-end gap-3">
                        {institutionsByMonth.map((month, index) => (
                            <div key={month.month} className="flex-1 flex flex-col items-center gap-2">
                                <div
                                    className="w-full bg-accent rounded-t-md transition-all duration-500 ease-out"
                                    style={{
                                        height: `${Math.max(month.count * 60, 8)}px`,
                                        animationDelay: `${index * 50}ms`,
                                    }}
                                />
                                <span className="text-xs text-(--secondary)">{month.month}</span>
                            </div>
                        ))}
                    </div>
                </Card>
            ...
            <Card className="animate-fadeInUp">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                        ...
                        <p className="text-sm text-(--secondary) mt-1">Manage existing institutions</p>
                    </Link>
                    <Link
                        href="/institutions"
                        className="p-4 rounded-lg border border-(--border) hover:border-warning hover:bg-(--warning-light) transition-all duration-200 group"
                    >
                        <div className="w-10 h-10 rounded-md bg-(--warning-light) text-[#B45309] flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p className="text-sm text-(--secondary) mt-1">See the public listing</p>
                    </Link>
                </div>
            </Card>
        </div>
