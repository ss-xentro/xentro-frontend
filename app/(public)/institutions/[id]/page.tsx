...
export default function InstitutionProfilePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (loading || !institution) {
        return <div className="min-h-screen bg-[#0B0D10] text-white flex items-center justify-center">
            ...
            <div className="bg-white/5 border-b border-white/10">
                <div className="container mx-auto px-4 py-8 md:py-12">
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        <div className="w-24 h-24 md:w-32 md:h-32 rounded-xl bg-white/10 border border-white/20 p-4 shadow-sm flex items-center justify-center shrink-0">
                            {institution.logo ? (
                        ...
                        <div className="flex-1">
                            <div className="flex flex-wrap items-center gap-3 mb-2">
                                ...
                                <Badge variant="outline" className="ml-2 border-white/20 text-gray-300">{typeInfo.label}</Badge>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4 md:gap-8">
                                ...
                                <div className="flex items-center gap-2 text-gray-400">
                                    ...
                                    {institution.website ? (
                                        ...
                                        <span className="text-gray-400">No website yet</span>
                                    )}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <Card className="text-center p-6 bg-white/5 border-white/10 border">
                                    <p className="text-3xl font-bold text-white mb-1">{formatNumber(institution.startupsSupported ?? 0)}</p>
                                    <p className="text-sm text-gray-400">Startups Supported</p>
                                </Card>
                                <Card className="text-center p-6 bg-white/5 border-white/10 border">
                                    <p className="text-3xl font-bold text-white mb-1">{formatNumber(institution.studentsMentored ?? 0)}</p>
                                    <p className="text-sm text-gray-400">People Mentored</p>
                                </Card>
                                <Card className="text-center p-6 bg-white/5 border-white/10 border">
                                    <p className="text-xl font-bold text-white mb-1 truncate" title={formatCurrency(Number(institution.fundingFacilitated ?? 0), institution.fundingCurrency ?? 'USD')}>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="p-6 bg-white/5 border-white/10 border">
                            ...
                            <div className="space-y-4">
                                {institution.email && (
                                    <a href={`mailto:${institution.email}`} className="flex items-center gap-3 text-gray-400 hover:text-violet-400 transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-medium text-gray-300">{institution.email}</p>
                                        </div>
                                    </a>
                                )}
                                {institution.phone && (
                                    <a href={`tel:${institution.phone}`} className="flex items-center gap-3 text-gray-400 hover:text-violet-400 transition-colors">
                                        <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-medium text-gray-300">{institution.phone}</p>
                                        </div>
                                    </a>
                                )}
                                {institution.website && (
                                    <a href={institution.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-violet-400 transition-colors">
                                        <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                                            </svg>
                                ...
                                {institution.linkedin && (
                                    <a href={institution.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-violet-400 transition-colors">
                                        <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
