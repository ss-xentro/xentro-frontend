...
export default function InvestorDashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        {
            name: 'Overview', href: '/investor-dashboard', icon: (
        ...
        {
            name: 'Deal Flow', href: '/investor-dashboard/deals', icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Portfolio', href: '/investor-dashboard/portfolio', icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            name: 'Settings', href: '/investor-dashboard/settings', icon: (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
