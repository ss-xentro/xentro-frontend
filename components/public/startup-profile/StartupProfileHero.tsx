					...
					<div className="flex flex-col md:flex-row gap-6 pt-1">
						...
						<div className="flex-1 min-w-0 flex flex-col">
							...
							<div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-(--secondary)">
								...
								{startup.programs && startup.programs.length > 0 && (
									<span className="flex items-center gap-1.5">
										<svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
										{startup.programs[0].name}
									</span>
								)}
							</div>
					...
					<div className="flex sm:hidden flex-wrap items-center gap-2 mt-4">
						...
						{startup.demoVideoUrl && (
							<button
								...
								className="flex-1 min-w-30 flex items-center gap-2 justify-center mt-2 px-4 h-10 rounded-full bg-red-600 hover:bg-red-500 active:bg-red-700 transition-colors text-white text-sm font-medium shadow-lg shadow-red-900/25 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-background"
								aria-label="Watch pitch video"
							>
								<svg className="w-4 h-4 shrink-0 ml-0.5" fill="currentColor" viewBox="0 0 24 24">
				...
				<div className="mt-6">
					{startup.demoVideoUrl && (
						<button
							type="button"
							onClick={() => setIsVideoModalOpen(true)}
							className="hidden sm:flex items-center gap-2 px-4 h-10 rounded-full bg-red-600 hover:bg-red-500 active:bg-red-700 transition-colors text-white text-sm font-medium shadow-lg shadow-red-900/25 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-background"
							aria-label="Watch pitch video"
						>
							<svg className="w-4 h-4 shrink-0 ml-0.5" fill="currentColor" viewBox="0 0 24 24">
								<path d="M8 5v14l11-7z" />
