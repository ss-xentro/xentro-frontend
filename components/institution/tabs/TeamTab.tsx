					...
					return (
						<Card key={member.id} className="p-6 bg-(--accent-subtle) border-(--border) border" hoverable>
							<div className="flex items-start gap-4">
								<div className="w-12 h-12 rounded-full bg-violet-100 dark:bg-violet-500/20 flex items-center justify-center text-xl font-bold text-violet-700 dark:text-violet-300 shrink-0">
