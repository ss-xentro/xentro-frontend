...
// ── Re-export sonner's toast directly for imperative use ─────────────────────
export { toast };

// ── useToast — compatibility hook for existing callers ────────────────────────
// Returns the same API shape as the old custom ToastProvider hook.
// All calls are forwarded to sonner's `toast` which is wired to <Toaster /> in providers.tsx.
...
// ── ToastProvider — kept for import compatibility; Toaster is in providers.tsx ─
// This is now just a passthrough wrapper. The actual <Toaster /> lives in providers.tsx.
